...
export const addAnchorTagsToText = (text: string) => {
    ...
    while (value) {
        ...
        newMessage = newMessage.replaceAll(link, `<a href="${link}" target="_blank">${link}</a>`);
 ...
 */
export const regexStringSearch = (search: string | RegExp, value: string, regexPattern = 'ig'): boolean => {
    const reg = new RegExp(search instanceof RegExp ? search : escapeRegex(search), regexPattern);
 ...
 */
export const regexStringListSearch = (search: string | RegExp, values: string[], regexPattern = 'ig'): boolean => {
    const reg = new RegExp(search instanceof RegExp ? search : escapeRegex(search), regexPattern);
